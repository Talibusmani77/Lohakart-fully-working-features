import { Linkedin, Mail, MapPin, Phone, ArrowUp, X, HelpCircle, FileText } from 'lucide-react';
  ...
  return (
    <>
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-6 right-6 z-50 w-12 h-12 md:w-14 md:h-14 bg-[#be1800] hover:bg-[#a01500] text-white rounded-full shadow-2xl flex items-center justify-center transition-all hover:scale-110 active:scale-95"
